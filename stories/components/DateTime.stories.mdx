...
import { DatePicker, DateRangePicker, TimePicker, TimeRangePicker, DateTimePicker } from '../../src';
...
<ArgsTable components={{ DatePicker, DateRangePicker, TimePicker, DateTimePicker }} />